var token = "pk.eyJ1IjoibW1heTUxNTk4IiwiYSI6ImNrN2xmY2RjNzAxcm8zaHBveHl1a3E5dTAifQ.R4Ua_3ogYpZlizOr6Pc6Fw"
...
startPos = [data.locations[0].latitudeE7 * SCALAR_E7, data.locations[0].longitudeE7 * SCALAR_E7]
var mymap = L.map('mapid').setView(startPos, 13);
...
function addLatLngs(latLngs, color) {
...
for (var i = 0; i < data.locations.length; ++i) {
  ...
  latLngs.push([l.latitudeE7 * SCALAR_E7, l.longitudeE7 * SCALAR_E7])
}

addLatLngs(latLngs, "blue")
